<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Checkout.aspx.cs" Inherits="HotelManagementApplication.Manage_Bookings.Check_Out" %>
...
<head runat="server">
  ...
  <link href="../Content/CheckOut/CheckOut.css" rel="stylesheet" />
</head>
      ...
      <nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top " id="navigation-example">
        <div class="container-fluid">
          <div class="navbar-wrapper">
            <a class="navbar-brand" href="javascript:void(0)">Check Out</a>
          </div>
